...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  const [currentNav, setCurrentNav] = useState<"bookings" | "amount" | "rating">("bookings");
  ...
  const {
    ...
    error: erroGettingUserData,
  } = useSWR("/api/users", fetchUserData);

  if (error || erroGettingUserData) throw new Error("Cannot Fetch Data");
  ...
  return (
    <div className="container mx-auto px-2 md:px-4 py-10 ">
      <div className="grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 lg:cols-span-9 ">
          <div className="flex items-center ">
